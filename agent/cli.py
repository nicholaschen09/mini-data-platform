...
def run_repl():
    ...
    console.print("  [medium_purple]•[/medium_purple] Which two products are most frequently bought together?")
    console.print("  [medium_purple]•[/medium_purple] Are there any anomalies with how we sell products?")
    console.print()
